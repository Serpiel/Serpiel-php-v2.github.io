...
<head>
    <meta charset="UTF-8">
    <title><?php require_once "menu.php"; echo $title ?></title>
...
<body>
    ...
    <header>
        <nav>
            <ul>
                ...
                <li><a href="Core/Pages/games.html"> Games</a></li>
                <li><a href="Core/Pages/lore.html"> Lore</a></li>
                <li><a href="Core/Pages/about.html"> About</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main>
        ...
        <section class="categorie">
            <a href="Core/Pages/games.html"><img src="https://www.micromania.fr/dw/image/v2/BCRB_PRD/on/demandware.static/-/Sites-masterCatalog_Micromania/default/dw02baa646/images/high-res/3330628_scrmax.jpg?sw=480&sh=480&sm=fit" width="350" height="200"></a>
            <h2>Games</h2>
        ...
        <section class="categorie2">
            <a href="Core/Pages/lore.html"><img src="https://wallpapercave.com/wp/DgVRjoJ.jpg" width="350" height="200"></a>
            <h2>Lore</h2>
